...
class Notifier implements INotifier {
	...
	public function getName(): string {
		return $this->factory->get('nmc_welcome_popup')->t('First run wizard');
	}
	...
	public function prepare(INotification $notification, string $languageCode): INotification {
		if ($notification->getApp() !== 'nmc_welcome_popup') {
			// Not my app => throw
	...
	protected function getSubject(INotification $notification, string $languageCode): string {
		$l = $this->factory->get('nmc_welcome_popup', $languageCode);
	...
	protected function setAppHintDetails(INotification $notification, $languageCode, $app) {
		...
		$notification
			...
			->setIcon($this->url->getAbsoluteURL($this->url->imagePath('nmc_welcome_popup', 'apps/'. $app . '.svg')));
		return $notification;
	}
